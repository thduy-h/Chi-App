        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400 sm:max-w-xs sm:text-left">
              Không gian nhỏ cho hai người cùng lên kế hoạch, giữ nhịp sống gọn gàng và gần nhau hơn.
            </p>
            ...
            <ul className="mt-8 flex justify-center gap-4 sm:justify-start">
              <li>
                <Link
                  ...
                  href="https://github.com/thduy-h/Chi-App"
                  rel="noreferrer"
                  target="_blank"
                >
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-gray-900 dark:text-white">Thông tin</p>
            ...
            {categories.length > 0 && (
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-gray-900 dark:text-white">Danh mục</p>
            ...
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-gray-900 dark:text-white">Liên kết nhanh</p>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6 dark:border-gray-300">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              <span className="block sm:inline">Bảo lưu mọi quyền.</span>
            ...
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400 sm:order-first sm:mt-0">
              &copy; <span>{new Date().getFullYear()}</span> LoveHub
            </p>
          </div>
        </div>
      </div>
